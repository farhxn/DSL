...
<head>
    ...
    <title>DSL Tasks Management</title>
            ...
            <div class="auth-box p-4 bg-white rounded">
                <div>
                    <div class="logo text-center">
                        ...
                        <h5 class="font-weight-medium mb-3 mt-1">Sign Up to DSL Tasks Management</h5>
                    </div>
                    <!-- Form -->
                    <div class="row mt-4">
                        <div class="m-1">
                        ...
                        <div class="col-12">
                            <form class="form-horizontal" method="post" action="{{ url('register') }}">
                                @csrf
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="email" name="email" class="form-control form-input-bg" id="tb-remail" placeholder="john@gmail.com" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="password" name="password" class="form-control form-input-bg" id="text-rpassword" placeholder="*****" required>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="password" name="password_confirmation" class="form-control form-input-bg" id="text-rcpassword" placeholder="*****" required>
                                    ...
                                    <div class="form-group mb-0 mt-4">
                                        <div class="col-sm-12 justify-content-center d-flex">
                                            <p>Already Signed Up? <a href="{{ url('login') }}" class="text-info font-weight-medium ms-1">Login</a></p>
                                        </div>
                                    </div>
                                </form>
                        </div>
