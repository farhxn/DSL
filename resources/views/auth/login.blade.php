...
<head>
    ...
    <title>DSL Task Management</title>
            ...
            <div class="auth-box p-4 bg-white rounded">
                <div id="loginform">
                    <div class="logo text-center">
                        ...
                        <h5 class="font-weight-medium mb-3 mt-1">Sign In to DSL Tasks Management</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form method="post" class="form-horizontal mt-3 form-material" id="loginform" action="{{ url('login') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="d-flex">
                                        ...
                                        {{-- <div class="ms-auto">
                                            <a href="javascript:void(0)" id="to-recover" class="link font-weight-medium d-flex align-items-center"><i class="ri-lock-line fs-5 me-1"></i> Forgot pwd?</a>
                                        </div> --}}
                                    </div>
                                </div>
                                ...
                                {{-- <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 mt-2 text-center">
                                        <div class="social mb-3">
                                            <a href="javascript:void(0)" class="btn  btn-facebook" data-bs-toggle="tooltip" title="Login with Facebook"> <i aria-hidden="true" class="ri-facebook-box-fill fs-4"></i> </a>
                                            <a href="javascript:void(0)" class="btn btn-googleplus" data-bs-toggle="tooltip" title="Login with Google"> <i aria-hidden="true" class="ri-google-fill fs-4"></i> </a>
                                        </div>
                                    </div>
                                </div> --}}
                                <div class="form-group mb-0 mt-4">
                                    <div class="col-sm-12 justify-content-center d-flex">
                                        <p>Don't have an account? <a href="{{ url('register') }}" class="text-info font-weight-medium ms-1">Sign Up</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
